...
{"0": {
    ...
    "doc": "Serial Bridge",
    "title": "Serial Bridge",
    "content": "This example compiles the serial bridge application which is used to communicate to WINC devices from PC. ",
    "url": "http://localhost:4000/wireless_apps_winc1500/apps/serial_bridge/readme.html",
    "relUrl": "/apps/serial_bridge/readme.html"
  },"7": {
    "doc": "Serial Bridge",
    "title": "Description",
    "content": "Serial bridge application acts as a bridge between PC and WINC devices. For example firmware update project use serial bridge application to load the firmware to WINC device via serial bridge application located in host MCU. ",
    "url": "http://localhost:4000/wireless_apps_winc1500/apps/serial_bridge/readme.html#description",
    "relUrl": "/apps/serial_bridge/readme.html#description"
  },"8": {
    "doc": "Serial Bridge",
    "title": "Downloading and building the application",
    "content": "To download or clone this application from Github, go to the top level of the repository . Path of the application within the repository is apps/serial_bridge/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | sam_d21_xpro_winc1500.X | MPLABX project for SAMD21 and WINC3400 Xplained pro | . | sam_e54_xpro_winc1500.X | MPLABX project for SAME54 and WINC3400 Xplained pro | . |   |   | . ",
    "url": "http://localhost:4000/wireless_apps_winc1500/apps/serial_bridge/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/serial_bridge/readme.html#downloading-and-building-the-application"
  },"9": {
    "doc": "Serial Bridge",
    "title": "Setting up SAMXXX Xplained Pro board",
    "content": ". | Connect the Debug USB port on the SAMXXX Xplained Pro board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/wireless_apps_winc1500/apps/serial_bridge/readme.html#setting-up-samxxx-xplained-pro-board",
    "relUrl": "/apps/serial_bridge/readme.html#setting-up-samxxx-xplained-pro-board"
  },"10": {
    "doc": "Serial Bridge",
    "title": "Running the Application",
    "content": ". | Open the project. | Build and program the generated code into the hardware using its IDE. | Please refer to “WINC Firmware Update Guide” for more information. | Please note this example will not output any console messages. | . ",
    "url": "http://localhost:4000/wireless_apps_winc1500/apps/serial_bridge/readme.html#running-the-application",
    "relUrl": "/apps/serial_bridge/readme.html#running-the-application"
  },"11": {
    "doc": "TCP Client",
    "title": "TCP Client",
...
var home_index_string = "Harmony 3 Wireless application examples for WINC1500";
