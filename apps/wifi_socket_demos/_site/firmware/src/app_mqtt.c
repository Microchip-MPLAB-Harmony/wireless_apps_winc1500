...
#define APP_MQTT_SUBSCRIBE_TOPIC_NAME   "MCHP/Sample/b"
#define APP_MQTT_SUBSCRIBE_QOS          1

#define APP_MQTT_PUBLISH_TOPIC_NAME     "MCHP/Sample/a"
...
void APP_MQTT_Tasks(DRV_HANDLE wdrvHandle) {
    ...
    if ((APP_MQTT_STATUS_LOWER_LAYER_DOWN != hdl->eStatus) && (APP_MQTT_STATUS_IDLE != hdl->eStatus)) {
